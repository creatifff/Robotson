                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-m-txt-c" align="left">
                                                                <h1 style="color: #ffffff; line-height: 100%;">Robotson</h1>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                    ...
                    <tr>
                        <td class="esd-stripe" align="center">
                            <table class="es-content-body" width="600" cellspacing="0" cellpadding="0" bgcolor="#ffffff"
                                ...
                                <tr>
                                    <td class="esd-structure es-p40t es-p40b es-p35r es-p35l" esd-custom-block-id="7796"
                                        align="left">
                                        <!--[if mso]>
                                        <table width="530" cellpadding="0" cellspacing="0">
                                            <tr>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-text es-p25t" align="center">
                                                                <h2 style="color: #ffffff; font-size: 24px;">Get 25% off
                                                                    your next order.</h2>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="esd-block-button es-p30t es-p15b es-p10r es-p10l"
                                                                align="center"><span class="es-button-border"><a
                                                                        href="https://viewstripo.email/"
                                                                        class="es-button"
                                                                        target="_blank">Awesome</a></span></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-p15b" align="center"
                                                                style="font-size:0"><a target="_blank"><img
                                                                        ...
                                                                        alt="Beretun logo" style="display: block;"
                                                                        title="Beretun logo" width="37"></a></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td esdev-links-color="#777777" align="left"
                                                                ...
                                                                <p style="color: #777777;">If you didn't create an
                                                                    account using this email address, please ignore this
                                                                    email or&nbsp;<u><a target="_blank"
                                                                                        style="color: #777777;"
