...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Collection::query()->create([
            ...
            'image_path' => 'images/humanoids.jpg'
        ]);
        Collection::query()->create([
            'name' => 'Транспортные платформы',
            'image_path' => 'images/transports.jpg'
        ]);
        Collection::query()->create([
            'name' => 'Манипуляторы',
            'image_path' => 'images/manipulators.jpg'
        ]);
        Collection::query()->create([
            'name' => 'Роботы для дома',
            'image_path' => 'images/domrobots.webp'
        ]);
        Collection::query()->create([
            'name' => 'Запчасти',
            'image_path' => 'images/details.jpg'
        ]);
